...
class Index extends Component
{
    ...
    {
        return Purchase::with(['purchaseDetail.goods', 'pengguna.pegawai', 'stokMasuk', 'expenditure.pengguna'])->whereBetween('date', [$this->date1, $this->date2])->orderBy('created_at', 'desc')->get();
    }
