...
class Form extends Component
{
    ...
    public $name, $address, $phone_number, $start_date, $birth_date, $gender, $nik, $npwp, $bpjs_health, $wages, $allowance, $transport_allowance, $bpjs_health_cost, $office, $position;
