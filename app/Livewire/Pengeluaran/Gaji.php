        ...
        DB::transaction(function () {
            ...
            foreach ($this->detail as $key => $row) {
                ...
                $expenditure[] = [
                    ...
                    'user_id' => auth()->id(),
                    'type' => 'gaji',
                    'description' => 'Tunjangan ' . $row['name'],
                    'employee_id' => $row['id'],
                    'cost' => $row['allowance'],
                    'created_at' => $now,
                    'updated_at' => $now
                ...
                $expenditure[] = [
                    ...
                    'user_id' => auth()->id(),
                    'type' => 'gaji',
                    'description' => 'Tunjangan Transport ' . $row['name'],
                    'employee_id' => $row['id'],
                    'cost' => $row['allowance'],
                    'created_at' => $now,
                    'updated_at' => $now
                ...
                $expenditure[] = [
                    ...
                    'user_id' => auth()->id(),
                    'type' => 'gaji',
                    'description' => 'BPJS Kesehatan ' . $row['name'],
                    'employee_id' => $row['id'],
            ...
            foreach ($this->otherCost as $key => $row) {
                $expenditure[] = [
                    ...
                    'user_id' => auth()->id(),
                    'type' => 'gaji',
                    'description' => 'Uang Makan ' . $row['name'],
                    'employee_id' => $row['id'],
                    'cost' => $row['uang_makan'],
                    'created_at' => $now,
                    'updated_at' => $now
                ...
                $expenditure[] = [
                    ...
                    'user_id' => auth()->id(),
                    'type' => 'gaji',
                    'description' => 'Jasa Pelayanan ' . $row['name'],
                    'employee_id' => $row['id'],
