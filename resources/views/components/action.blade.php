<div>
    <div class="btn-group btn-group-sm">
        @if ($delete)
            <a href="javascript:;" wire:click="delete('{{ $row['id'] }}')" style="display: none"
                class="delete{{ $row['id'] }} delete btn btn-warning">Hapus</a>
        @endif
        @if ($permanentDelete)
            <a href="javascript:;" wire:click="permanentDelete('{{ $row['id'] }}')" style="display: none"
                class="delete{{ $row['id'] }} delete btn btn-danger">Hapus Permanen</a>
        @endif
        <a href="javascript:;" onclick="deleteOrCancel('{{ $row['id'] }}')" style="display: none"
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            @endif
            @if ($restore)
                <a href="javascript:;" wire:click="restore('{{ $row['id'] }}')" class="dropdown-item">Restore</a>
            @endif
            @if ($detail)
            ...
            @endif
            @if ($delete)
                <a href="javascript:;" onclick="deleteOrCancel('{{ $row['id'] }}')" class="dropdown-item">Hapus</a>
            @endif
            @if ($custom)
                {!! $custom !!}
            @endif
