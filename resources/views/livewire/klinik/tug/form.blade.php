<div>
    @section('title', 'Tambah TUG')

    @section('breadcrumb')
        <li class="breadcrumb-item">Pelayanan</li>
        <li class="breadcrumb-item">TUG</li>
        <li class="breadcrumb-item active">Tambah</li>
    @endsection

    <h1 class="page-header">TUG <small>Tes Get Up and Go <small>Tambah</small></small></h1>
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <form wire:submit.prevent="submit">
                            ...
                            <div class="note-content">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group"> <input type="number" id="waktu_tes_detik"
                                            ...
                                            wire:model="waktu_tes_detik" step="0.01" class="form-control" required>
            ...
            <div class="panel-footer">
                ...
                @endrole
                <a href="/klinik/tug" class="btn btn-warning m-r-3">Data</a>
            </div>
        </form>
    </div>
</div>
